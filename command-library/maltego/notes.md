...
This document captures **general operational considerations** observed when using Maltego for small, defensible graphs in Atlas cases.

It is intended as a reference for maintaining **consistency and quality**, not as a troubleshooting guide.
...
- Canonical links are documented in `cases/<case>/sources.md`
